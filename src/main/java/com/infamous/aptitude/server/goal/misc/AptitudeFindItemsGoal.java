...
public class AptitudeFindItemsGoal<T extends MobEntity> extends Goal {
    ...
    public AptitudeFindItemsGoal(T mob, Predicate<ItemEntity> itemEntityPredicate, int randomInterval) {
      ...
      public boolean canUse() {
         if (!this.shouldFindItem(this.getFoundItemBySlot())) {
            return false;
            ...
            if (!this.canMove()) {
               ...
               return !list.isEmpty() && this.shouldFindItem(this.getFoundItemBySlot());
            }
         } else {
            return false;
         }
    ...
    public void tick() {
         ...
         if (this.shouldFindItem(itemBySlot) && !list.isEmpty()) {
