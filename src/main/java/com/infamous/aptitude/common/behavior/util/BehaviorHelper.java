...
public class BehaviorHelper {
    ...
    public static <U> MemoryModuleType<U> parseMemoryTypeString(String type) {
        ...
        if(memoryType == MemoryModuleType.DUMMY && !location.toString().equals("minecraft:dummy")) throw new JsonParseException("Invalid MemoryModuleType: " + type);
    ...
    public static SensorType<?> parseSensorType(JsonElement jsonElement) {
        ...
        if(sensorType == SensorType.DUMMY && !location.toString().equals("minecraft:dummy")) throw new JsonParseException("Invalid SensorType: " + type);
        return sensorType;
    }
    ...
    public static <U extends Entity> EntityType<U> parseEntityTypeString(String entityTypeString) {
        ...
        if(entityType == EntityType.PIG && !etLocation.toString().equals("minecraft:pig")) throw new JsonParseException("Invalid EntityType: " + entityTypeString);
    ...
    public static Activity parseActivityString(String activityString) {
        ...
        if(activity == Activity.IDLE && !activityLocation.toString().equals("minecraft:idle")) throw new JsonParseException("Invalid Activity: " + activityString);
        return activity;
    }
    ...
    public static SoundEvent parseSoundEventString(JsonObject jsonObject, String memberName){
        ...
        if(soundEvent == SoundEvents.ITEM_PICKUP && !seLocation.toString().equals("minecraft:entity.item.pickup")) throw new JsonParseException("Invalid SoundEvent: " + soundTypeString);
        return soundEvent;
    }
